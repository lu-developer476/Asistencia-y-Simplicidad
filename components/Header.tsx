...
export function Header() {
  ...
  return <header className="site-header"><div className="container header-inner">
    <Link href="#inicio" className="brand" onClick={()=>setOpen(false)} aria-label="Gestoría AyS - inicio"><Image src="/logo.jpg" alt="" width={34} height={34} className="brand-logo" priority/><span>GESTORÍA AyS</span></Link>
